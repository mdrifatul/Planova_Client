    ...
    <div className="min-h-screen bg-transparent dark:bg-gray-950 pt-20 pb-12">
      <div className="container mx-auto px-4">
        <section className="text-center mb-24 max-w-4xl mx-auto">
          <Badge
            variant="outline"
            className="mb-4 border-teal-500/20 text-teal-600 dark:text-teal-400 py-1 px-4 rounded-full"
          >
            Our Journey
          </Badge>
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Revolutionizing how people discover and organize experiences.
            Planova is your ultimate companion for finding, booking, and
            managing events that matter.
          </p>
        </section>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          <Card className="bg-zinc-50 dark:bg-gray-900/70 border-none shadow-sm h-full flex flex-col justify-center p-8 transition-transform hover:scale-[1.01]">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To empower communities by providing a seamless platform for event
              discovery and engagement. We believe every event is an opportunity
          ...
          <Card className="bg-zinc-50 dark:bg-gray-900/70 border-none shadow-sm h-full flex flex-col justify-center p-8 transition-transform hover:scale-[1.01]">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To become the world's most trusted event ecosystem, where every
              organizer and attendee can interact with total transparency and
              ease, globally.
            </p>
          </Card>
        </div>
            ...
            {[
              {
                title: "Innovation",
                description:
                  "Constantly evolving our tools for a better user experience.",
                icon: Sparkles,
              },
              {
                title: "Community",
                description:
                  "Building bridges between organizers and attendees.",
                icon: Users,
              },
              {
                title: "Excellence",
                description:
                  "Striving for quality in every interaction on our platform.",
                icon: CheckCircle2,
              },
            ].map((value, idx) => (
        ...
        <section className="bg-teal-600 py-20 rounded-3xl text-white text-center shadow-xl shadow-teal-500/10 mb-24 overflow-hidden relative">
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="text-teal-100 uppercase text-xs font-bold tracking-widest">
                Global Events
              </div>
            </div>
            <div>
