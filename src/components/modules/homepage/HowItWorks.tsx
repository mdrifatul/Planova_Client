  ...
  const steps = [
    {
      ...
      description:
        "Explore a curated list of events happening around you, filtered by your interests.",
      icon: Search,
      color: "bg-teal-500",
    },
    {
      title: "Book Securely",
      description:
        "Fast and secure registration process for both free and paid events.",
      icon: Ticket,
      color: "bg-blue-500",
    },
    {
      ...
      description:
        "Attend events, connect with like-minded people, and grow your network.",
      icon: Users,
      color: "bg-purple-500",
    },
  ];
    ...
    <section className="py-24 bg-white dark:bg-gray-950 transition-colors duration-500">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            A seamless three-step process designed to get you from discovery to
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div
                className={`w-20 h-20 rounded-3xl ${step.color} flex items-center justify-center text-white shadow-xl group-hover:scale-110 transition-transform duration-300 mb-8`}
              >
                <step.icon size={36} />
